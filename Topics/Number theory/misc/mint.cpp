...
struct Mint {
  ...
  Mint& operator-=(const Mint& o) {return *this = *this - o;}
  friend Mint operator*(const Mint& l, const Mint& r) {return (long long)l.x * r.x;}
  Mint& operator*=(const Mint& o) {return *this = *this * o;}
  Mint pow(long long b) const {
    Mint ans = 1;Mint a = *this;
    for (; b; b >>= 1, a = a * a)
      if (b & 1)
        ans *= a;
    return ans;
...
Mint c(int n, int r) {return n < r || r < 0 ? 0 : fac[n] * rfac[r] * rfac[n - r];}